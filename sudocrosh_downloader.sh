...
echo "║                                     HOW TO INSTALL:                                                                                ║"
echo "║                                                                                                                                    ║"
echo "║  - Install Linux development environment and start it up.                                                                          ║"
echo "║  - Open crosh shell (ctrl-alt-t), copy paste, and run:                                                                             ║"
echo "║                                                                                                                                    ║"
...
echo "║  curl -L https://raw.githubusercontent.com/shadowed1/sudoCrosh/main/minioverride.c -o mnt/shared/MyFiles/Downloads/minioverride.c  ║"
